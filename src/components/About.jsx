...
function About() {
    return (
        <React.Fragment>
            <div className="container min-h-screen grid place-items-center mx-auto">
                ...
                <div className="flex lg:gap-x-8 gap-2 items-center flex-col-reverse lg:flex-row">
                    <div className="p-4 lg:w-1/2 h-1/2 bg-white/10 backdrop-blur-[10px] rounded-2xl border border-white shadow-[0_8px_32px_0_rgba(31, 38, 135, .37)]">
                    ...
                    <div className="w-3/4 lg:w-1/2 h-1/2 bg-white/10 backdrop-blur-[10px] rounded-2xl border border-white shadow-[0_8px_32px_0_rgba(31, 38, 135, .37)]">
                        <img src={about} alt="" />
                    </div>   
                </div>
            </div>
