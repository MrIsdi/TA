...
function Home() {
    return (
        <React.Fragment>
            <div className="container min-h-screen grid place-items-center mt-16" id='home'>
                <div className='flex justify-center lg:justify-normal lg:flex-row-reverse flex-col relative bg-white/10 backdrop-blur-[10px] rounded-2xl border border-white/25 shadow-[0_8px_32px_0_rgba(31, 38, 135, .37)] w-3/4 lg:w-2/3 h-1/2'>
